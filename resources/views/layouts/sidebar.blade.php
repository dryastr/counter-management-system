                ...
                <li class="sidebar-item has-sub {{ Request::is('add-users*') ? 'active' : '' }}">
                    ...
                    <ul class="submenu">
                        <li class="submenu-item {{ Request::routeIs('add-users.index') ? 'active' : '' }}">
                            <a href="{{ route('add-users.index') }}" class="submenu-link">Daftar Karyawan</a>
                        </li>
                    </ul>
                </li>

                <li class="sidebar-item has-sub {{ Request::is('type-products*') ? 'active' : '' }}">
                    <a href="#" class='sidebar-link'>
                        <i class="bi bi-card-checklist"></i>
                    ...
                    <ul class="submenu">
                        <li class="submenu-item {{ Request::routeIs('type-products.index') ? 'active' : '' }}">
                            <a href="{{ route('type-products.index') }}" class="submenu-link">Daftar Tipe Produk</a>
                        </li>
                    </ul>
                </li>
            @endif
